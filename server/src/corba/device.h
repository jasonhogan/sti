...
_CORBA_MODULE_BEG
  ...
  public:
    ...
    char* deviceType() { return pd_obj->deviceType(); }
  ...
  public:
    ...
    ::CORBA::Boolean registerDevice(const char* deviceName, STI_Server_Device::TDevice& device) { return pd_obj->registerDevice(deviceName, device); }
