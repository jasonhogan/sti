...
#define __STI_mServer__Device_mDeviceConfigure__
    ...
    public:
      ...
      virtual ::CORBA::Boolean setChannel(::CORBA::Short channel, const ::STI::Types::TValMixed& value) = 0;
...
#define __STI_mServer__Device_mDeviceTimingSeqControl__
    ...
    public:
      // IDL operations
      ::CORBA::Boolean transferEvents(const ::STI::Types::TDeviceEventSeq& events, ::CORBA::Boolean dryrun);
      char* transferErr();
    ...
    public:
      ...
      virtual ::CORBA::Boolean transferEvents(const ::STI::Types::TDeviceEventSeq& events, ::CORBA::Boolean dryrun) = 0;
      ...
      virtual void stop() = 0;
      virtual void waitForStatus(::STI::Types::DeviceStatus status) = 0;
      virtual ::CORBA::Boolean ping() = 0;
...
#define __STI_mServer__Device_mServerConfigure__
    ...
    public:
      ...
      virtual ::CORBA::Boolean registerDevice(::STI::Types::TDevice& device, ::STI::Server_Device::DeviceBootstrap_ptr bootstrap) = 0;
      virtual ::CORBA::Boolean removeDevice(const char* deviceID) = 0;
      virtual char* generateDeviceID(const ::STI::Types::TDevice& device) = 0;
...
#define __STI_mServer__Device_mCommandLine__
    ...
    public:
      ...
      virtual ::CORBA::Boolean setAttribute(const char* key, const char* value) = 0;
      virtual char* getAttribute(const char* key) = 0;
      virtual ::CORBA::Boolean writeChannel(::CORBA::UShort channel, const ::STI::Types::TValMixed& value) = 0;
      virtual ::CORBA::Boolean readChannel(::CORBA::UShort channel, const ::STI::Types::TValMixed& value, ::STI::Types::TDataMixed_out data) = 0;
      virtual ::CORBA::Boolean preparePartnerEvents(const ::STI::Types::TDeviceEventSeq& eventsIn, ::STI::Server_Device::DeviceControlSeq& partnerControls, ::STI::Types::TStringSeq& antecedentDevices) = 0;
      virtual ::CORBA::Boolean registerPartnerDevice(::STI::Server_Device::CommandLine_ptr partnerCmdLine) = 0;
