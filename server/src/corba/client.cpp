...
#endif
static CORBA::TypeCode_ptr _0RL_tc_STI__Client__Server_mTDevice = CORBA::TypeCode::PR_struct_tc("IDL:STI_Client_Server/TDevice:1.0", "TDevice", _0RL_structmember_STI__Client__Server_mTDevice, 3, &_0RL_tcTrack);
