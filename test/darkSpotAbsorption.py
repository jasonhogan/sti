...
setvar('desc','''Tighter Focus: Dark spot absorption vs radius and probe frequency. Trial #6 -- blue of resonance (~361pm)''')

#setvar('signOfDetuning',-1)        #blue =+1, red=-1

setvar('imageCropVector',(480,611,150+50))
#setvar('imageCropVector',(480,568,50))
