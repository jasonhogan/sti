...
setvar('desc', "Mag Trap check - 0.04*s hold @ 30 - F=1, 220 MHz 20A CMOT - 0 MHz probe")
#setvar('desc', "cMOT check - 4.25A MOT, 40A cMOT, 11*ms at 210 MHz, 100% power, 40*ms sweep, 10*Mhz detuned imaging, 10*ms with 120 mW of 1530nm @ 367pm")
...
time = MOT(time, tClearTime=100*ms, cMOT = True, dtMOTLoad=MOTLoadTime, dtSweepToCMOT = 30*ms, cmotQuadCoilCurrent = varCMOTCurrent, dtMolasses = 0*ms, rapidOff = False, motQuadCoilCurrent = 4.25, dtCMOT = 5*ms, powerReduction = 0.7, CMOTFrequency = 210, dtNoRepump = 4*ms, repumpAttenuatorVoltage = 0)
...
if (magneticTrap) :
    setvar('varFullMagneticTrapCurrent', 30)
    setvar('varChargeCurrent', 30)
    setvar('varDischargeCurrent', 30)
