...
# Build Targets
.build-conf: ${BUILD_SUBPROJECTS} dist/Release/GNU-Linux-x86/device

dist/Release/GNU-Linux-x86/device: ${OBJECTFILES}
	${MKDIR} -p dist/Release/GNU-Linux-x86
	${LINK.cc} -o dist/Release/GNU-Linux-x86/device ${OBJECTFILES} ${LDLIBSOPTIONS} 

${OBJECTDIR}/src/corba/STI_Device.o: src/corba/STI_Device.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/corba
	$(COMPILE.cc) -O2 -o ${OBJECTDIR}/src/corba/STI_Device.o src/corba/STI_Device.cpp
...
${OBJECTDIR}/_ext/home/harv/docs/FPGA/sti/device/../server/src/corba/ORBManager.o: ../server/src/corba/ORBManager.cpp 
	...
	$(COMPILE.cc) -O2 -o ${OBJECTDIR}/_ext/home/harv/docs/FPGA/sti/device/../server/src/corba/ORBManager.o ../server/src/corba/ORBManager.cpp

${OBJECTDIR}/src/corba/DeviceControl_i.o: src/corba/DeviceControl_i.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/corba
	$(COMPILE.cc) -O2 -o ${OBJECTDIR}/src/corba/DeviceControl_i.o src/corba/DeviceControl_i.cpp

${OBJECTDIR}/src/corba/Attribute.o: src/corba/Attribute.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/corba
	$(COMPILE.cc) -O2 -o ${OBJECTDIR}/src/corba/Attribute.o src/corba/Attribute.cpp

${OBJECTDIR}/src/corba/testDevice.o: src/corba/testDevice.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/corba
	$(COMPILE.cc) -O2 -o ${OBJECTDIR}/src/corba/testDevice.o src/corba/testDevice.cpp

${OBJECTDIR}/src/corba/DataTransfer_i.o: src/corba/DataTransfer_i.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/corba
	$(COMPILE.cc) -O2 -o ${OBJECTDIR}/src/corba/DataTransfer_i.o src/corba/DataTransfer_i.cpp

${OBJECTDIR}/src/corba/Configure_i.o: src/corba/Configure_i.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/corba
	$(COMPILE.cc) -O2 -o ${OBJECTDIR}/src/corba/Configure_i.o src/corba/Configure_i.cpp

${OBJECTDIR}/src/corba/device.o: src/corba/device.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/corba
	$(COMPILE.cc) -O2 -o ${OBJECTDIR}/src/corba/device.o src/corba/device.cpp

${OBJECTDIR}/src/corba/deviceserver.o: src/corba/deviceserver.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/corba
	$(COMPILE.cc) -O2 -o ${OBJECTDIR}/src/corba/deviceserver.o src/corba/deviceserver.cpp
...
.clean-conf:
	${RM} -r build/Release
	${RM} dist/Release/GNU-Linux-x86/device
