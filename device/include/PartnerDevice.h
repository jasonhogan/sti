...
public:
	...
	bool prepareEvents(std::vector<STI::Server_Device::DeviceControl_var>& partnerControls);
	bool prepareEvents(STI::Server_Device::DeviceControlSeq& partnerControlSeq);
