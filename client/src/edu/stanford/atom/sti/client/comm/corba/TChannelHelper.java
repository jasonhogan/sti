...
/**
* Timing_Server/TChannelHelper.java .
...
{
  private static String  _id = "IDL:Timing_Server/TChannel/TChannel:1.0";
    ...
    if (__typeCode == null)
    {
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _tcOf_members0 = edu.stanford.atom.sti.client.comm.corba.TBoardHelper.type ();
  ...
  public static edu.stanford.atom.sti.client.comm.corba.TChannel read (org.omg.CORBA.portable.InputStream istream)
  {
    ...
    value.board = edu.stanford.atom.sti.client.comm.corba.TBoardHelper.read (istream);
  ...
  {
        edu.stanford.atom.sti.client.comm.corba.TBoardHelper.write (ostream, value.board);
