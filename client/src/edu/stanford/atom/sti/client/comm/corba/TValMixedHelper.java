...
/**
* Timing_Server/TValMixedHelper.java .
...
{
  private static String  _id = "IDL:Timing_Server/TValMixed/TValMixed:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      _disTypeCode0 = edu.stanford.atom.sti.client.comm.corba.TValueHelper.type ();
      ...
      _anyOf_members0 = org.omg.CORBA.ORB.init ().create_any ();
            edu.stanford.atom.sti.client.comm.corba.TValueHelper.insert (_anyOf_members0, edu.stanford.atom.sti.client.comm.corba.TValue.ValueNumber);
      ...
      _anyOf_members0 = org.omg.CORBA.ORB.init ().create_any ();
            edu.stanford.atom.sti.client.comm.corba.TValueHelper.insert (_anyOf_members0, edu.stanford.atom.sti.client.comm.corba.TValue.ValueString);
      ...
      _anyOf_members0 = org.omg.CORBA.ORB.init ().create_any ();
            edu.stanford.atom.sti.client.comm.corba.TValueHelper.insert (_anyOf_members0, edu.stanford.atom.sti.client.comm.corba.TValue.ValueDDSTriplet);
  ...
  public static edu.stanford.atom.sti.client.comm.corba.TValMixed read (org.omg.CORBA.portable.InputStream istream)
  {
        ...
        edu.stanford.atom.sti.client.comm.corba.TValue _dis0 = null;
    _dis0 = edu.stanford.atom.sti.client.comm.corba.TValueHelper.read (istream);
    switch (_dis0.value ())
    {
      case edu.stanford.atom.sti.client.comm.corba.TValue._ValueNumber:
        double _number = (double)0;
        _number = istream.read_double ();
        value.number (_number);
        break;
      case edu.stanford.atom.sti.client.comm.corba.TValue._ValueString:
        String _stringVal = null;
        _stringVal = istream.read_string ();
        value.stringVal (_stringVal);
        break;
      case edu.stanford.atom.sti.client.comm.corba.TValue._ValueDDSTriplet:
  ...
  {
        edu.stanford.atom.sti.client.comm.corba.TValueHelper.write (ostream, value.discriminator ());
