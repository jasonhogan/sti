...
class PcoSensicamDevice : public STI_Device
{
public:
...
private:
	...
	std::string PcoSensicamDevice::attrValue(std::string key);
	void PcoSensicamDevice::setAttrIfDifferent(std::string key, std::string value);
	void PcoSensicamDevice::setAttrFromValue(std::string key);
	void PcoSensicamDevice::Adjust_Buffersize();
