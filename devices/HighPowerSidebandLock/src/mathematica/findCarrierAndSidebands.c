...
DLLEXPORT int findCarrierAndSidebands(WolframLibraryData libData, MTensor A1, MTensor A2, mreal A3, mreal A4, MTensor *Res)
{
mbool B0_0;
mbool B0_1;
mbool B0_3;
...
S0[0] = I0_8;
S0[1] = I0_0;
err = libData->MTensor_getReal(*T0_2, S0, &R0_3);
if( err)
{
goto error_label;
}
