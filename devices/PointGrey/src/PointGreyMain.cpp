...
int main(int argc, char* argv[])
{
	...
	desc.add_options()
		("help", "FIXME DO THIS")
		("serialno,s", po::value<unsigned int>()->required(), "S/N of camera")
	...
	unsigned int sn = vm["serialno"].as<unsigned int>();
	...
	PointGreyDevice cam(orbManager, name, address, 0, sn, logdir);
