...
{
	std::cout << "Waiting for waitBeforeCollectData for num " << getEventNumber() << std::endl;
	...
	std::cout << "Done waiting for waitBeforeCollectData for num " << getEventNumber() << std::endl;
}
